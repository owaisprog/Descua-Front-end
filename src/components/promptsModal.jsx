...
function PromptsModal(props) {
 ...
 const handlePostRequest = async (e) => {
   ...
   try {
     const response = await fetch("http://localhost:7000/api/createPrompts", {
       method: "POST",
       headers: {
           ...
           <div className=" w-1/3 h-4/5 px-7  rounded-md bg-white shadow-slate-50 border border-white ease-out">
             ...
             <form onSubmit={handlePostRequest} className="my-8">
               ...
               <div className="flex flex-col gap-y-3 mt-3">
                 <h1 className="font-bold text-blue-950">Statement</h1>
                 <input
                   type="text"
                   name="statement"
                   required
               ...
               <div className="flex flex-col gap-y-3 mt-3 ">
                 <h1 className="font-bold text-blue-950">Date</h1>
